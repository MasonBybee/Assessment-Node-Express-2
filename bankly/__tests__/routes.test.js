...
describe("GET /users", function () {
  ...
  test("should deny access if token provided is not valid", async function () {
    const response = await request(app).get("/users").send({
      _token:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IktyYW5rZWQiLCJhZG1pbiI6dHJ1ZSwiaWF0IjoxNzEzMzg1MjQzfQ.quNbimv3N-zbySXPjYJ7iMTg4H323DT0mbqgpDasfOIs",
    });
    expect(response.statusCode).toBe(401);
  });
